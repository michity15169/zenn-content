...
`SEARCH INDEX`は全文検索以外にも使うことができ、[セカンダリインデックスではカバーしきれなかった複雑な検索](https://cloud.google.com/spanner/docs/full-text-search/search-vs-secondary-index)ができる特徴があります。
